    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('paidAt', models.DateTimeField(blank=True, null=tkinter.tix.Tree)),
                ('isDelivered', models.BooleanField(default=False)),
                ('deliveredAt', models.DateTimeField(blank=True, null=tkinter.tix.Tree)),
                ('createdAt', models.DateTimeField(auto_now_add=True, null=tkinter.tix.Tree)),
